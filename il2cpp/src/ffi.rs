...
import_gameassembly!(il2cpp_class_get_methods(class: *const u8, iter: *const *const c_void) -> *const u8 = 0x1548110);
...
import_gameassembly!(il2cpp_method_get_return_type(method: *const u8) -> *const u8 = 0x15496B0);
import_gameassembly!(il2cpp_method_get_name(method: *const u8) -> *const i8 = 0x1549640);
import_gameassembly!(il2cpp_method_get_param_count(method: *const u8) -> u32 = 0x15629C0);
import_gameassembly!(il2cpp_method_get_param(method: *const u8, index: u32) -> *const u128 = 0x1562950);
import_gameassembly!(il2cpp_method_get_param_name(method: *const u8, index: u32) -> *const i8 = 0x1549690);
import_gameassembly!(il2cpp_method_get_flags(method: *const u8) -> u32 = 0x1549600);

import_gameassembly!(il2cpp_object_new(class: *const u8) -> *const u8 = 0x1549870);

import_gameassembly!(il2cpp_runtime_invoke(method: *const u8, obj: *const u8, params: *const usize, exception: &mut usize) -> usize = 0x1549960);
...
import_gameassembly!(il2cpp_custom_attrs_from_method(method: *const u8) -> *const u8 = 0x1548390);
...
pub unsafe fn get_method_flags(method: *const u8) -> u16 {
    unsafe { *(method.cast::<u8>().add(56) as *const u16) }
}

pub unsafe fn il2cpp_class_get_token(class: *const u8) -> u32 {
    unsafe { *(class.cast::<u32>().add(61) as *const u32) }
}
